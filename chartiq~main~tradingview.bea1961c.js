(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['chartiq~main~tradingview'],
  {
    ...
    '0165': function (t, e, s) {
      ...
      function r(t, e, s) {
        return (
          ...
          function (e) {
            ...
            (s && (s === this || 8 & s.compareDocumentPosition(this))) ||
              t.call(this, e);
          }
        );
      }
        ...
        return t
          ...
          .map(function (t) {
            var e = '',
              s = t.indexOf('.');
            return (
              s >= 0 && ((e = t.slice(s + 1)), (t = t.slice(0, s))),
              {
                type: t,
                name: e,
              }
      ...
      e['a'] = function (t, e, s) {
        ...
        if (!(arguments.length < 2)) {
          for (o = e ? u : l, null == s && (s = !1), n = 0; n < r; ++n)
            this.each(o(i[n], e, s));
          return this;
        }
    ...
    '166a': function (t, e, s) {
      ...
      function x(t, e, s, n) {
        return n <= 0 && (t = e = s = NaN), new O(t, e, s, n);
      }
      function T(t) {
        return (
          t instanceof a || (t = C(t)),
      ...
      function k(t, e, s, n) {
        return 1 === arguments.length
          ? T(t)
          : new O(t, e, s, null == n ? 1 : n);
      }
      function O(t, e, s, n) {
        (this.r = +t), (this.g = +e), (this.b = +s), (this.opacity = +n);
      }
      function E() {
      ...
      function N(t) {
        ...
        if ((t instanceof a || (t = C(t)), !t)) return new A();
      ...
      function D(t, e, s, n) {
        return 1 === arguments.length
          ? N(t)
          : new A(t, e, s, null == n ? 1 : n);
      }
      function A(t, e, s, n) {
        (this.h = +t), (this.s = +e), (this.l = +s), (this.opacity = +n);
      }
      function L(t, e, s) {
        return (
          255 *
          ...
          Object(n['b'])(a, {
            ...
            rgb: function () {
              var t = (this.h % 360) + 360 * (this.h < 0),
                ...
                a = 2 * s - n;
              return new O(
                L(t >= 240 ? t - 240 : t + 120, a, n),
                L(t, a, n),
                L(t < 120 ? t + 240 : t - 120, a, n),
                this.opacity
              );
            },
            displayable: function () {
      ...
      function i(t, e, s, r) {
        ...
        return (
          ...
          (o.offset = function (t, s) {
            return e((t = new Date(+t)), null == s ? 1 : Math.floor(s)), t;
          }),
          ...
          (o.filter = function (s) {
            return i(
              function (e) {
                if (e >= e) while ((t(e), !s(e))) e.setTime(e - 1);
              },
              function (t, n) {
                if (t >= t)
                  if (n < 0) while (++n <= 0) while ((e(t, -1), !s(t)));
                  else while (--n >= 0) while ((e(t, 1), !s(t)));
              }
            );
          }),
          s &&
            ((o.count = function (e, i) {
              return (
                n.setTime(+e), a.setTime(+i), t(n), t(a), Math.floor(s(n, a))
              );
            }),
            (o.every = function (t) {
              return (
    ...
    '1aa1': function (t, e, s) {
      ...
      const f = {
        ...
        m = {
          setTours(t, e) {
            (t.tours = e), Object(l['d'])(d, 'tours', e);
          },
          setDefaultTours(t) {
            (t.tours = p), Object(l['d'])(d, 'tours', t.tours);
          },
          ...
          clearTours(t) {
            (t.tours = p), Object(l['d'])(d, 'tours', p);
          },
        },
        _ = {
            ...
            o.getTours(s)
              .then((e) => {
                e &&
                  ...
                  e.data.data &&
                  e.data.data.tours &&
                  t('setTours', JSON.parse(e.data.data.tours)),
    ...
    2739: function (t, e, s) {
      ...
      var r = i(0),
        ...
        d = i(5),
        h = i(6);
      r.range, o.range, c.range, l.range, u.range, d.range, h.range;
    },
    '364b': function (t, e, s) {
      'use strict';
      s.d(e, 'b', function () {
      ...
      function r(t, e, s) {
        return function () {
          ...
          null == n
            ? this.style.removeProperty(t)
            : this.style.setProperty(t, n, s);
        };
      }
      function o(t, e) {
        return (
          t.style.getPropertyValue(e) ||
          Object(n['a'])(t).getComputedStyle(t, null).getPropertyValue(e)
        );
      }
      e['a'] = function (t, e, s) {
        return arguments.length > 1
          ? this.each(
              (null == e ? a : 'function' === typeof e ? r : i)(
                t,
                e,
                null == s ? '' : s
              )
      ...
      e['a'] = {
        ...
        computed: {
          ...
          currentMarketwatchMap() {
            let t = {};
            if (!this.marketwatches) return t;
            let e = this.marketwatches[this.currentWatchId];
            if (!e || !e.items) return t;
        ...
        methods: {
          isInMarketwatch(t, e) {
            return (
              !this.marketwatches ||
              (0 !== Object.keys(this.currentMarketwatchMap).length &&
                this.currentMarketwatchMap &&
                this.currentMarketwatchMap[t + ':' + e])
            );
          },
          addToMarketWatch(t, e) {
            let s = this.instrumentManager.get(t, null, e);
            s &&
              this.$events.emit(i['c'].EVENTS.ADD, {
                instrument: s,
              });
          },
        },
                        ...
                        ? s(
                            ...
                            [
                              s(
                                ...
                                {
                                  staticClass:
                                    'seven columns tradingsymbol-wrapper',
                                },
                                [
                                  s(
                                    'h3',
                                    ...
                                    [
                                      ...
                                      s(
                                        ...
                                        [
                                          t._v(
                                            t._s(t.currentInstrument.exchange)
                                          ),
                                        ]
                                      ),
                                      t._v(' '),
                                      t.currentInstrument.auctionNumber
                                        ? s(
                                            'span',
                                            {
                                              staticClass:
                                                'text-label orange tag-auction',
                                            },
                                            [
                                              t._v(
                                                'AUCTION #' +
                              ...
                              s(
                                'empty-state',
                                {
                                  attrs: {
                                    image: t.getStatic(
                                      t.appendThemeName(
                                        'images/illustrations/marketwatch.svg'
                                      )
                                    ),
                                  },
                                },
                                [
                                  s(
                                    ...
                                    [
                                      s('h2', [t._v('Find an instrument')]),
                                      t._v(' '),
                                      s('p', [
                                        t._v(
                                          'Use the above search bar to find an instrument'
                                        ),
                                      ]),
                                    ]
                                  ),
          ...
          computed: {
            ...
            isCreateGTT() {
              return (
                ...
                ('NSE' === this.currentInstrument.exchange ||
                  'BSE' === this.currentInstrument.exchange ||
                  'NFO' === this.currentInstrument.exchange)
              );
            },
          },
          methods: {
            show(t) {
              (this.params = t),
                t && t.instrument
                  ? ((this.currentInstrument = t.instrument),
                    (this.currentToken = t.instrument.instrumentToken))
    ...
    '58b4': function (t, e, s) {
          ...
          return s(
            ...
            [
              t.isLoader
                ...
                : t._e(),
              t._v(' '),
              t.isDepthLoaded || t.isExtendedDepthLoaded
                ? s(
                    'div',
                    {
                      directives: [
                    ...
                    [
                      ...
                      t.isExtendedDepthAvailable
                        ? s(
                            ...
                            [
                              t.isExtendedDepth && !t.isExtendedDepthLoaded
                                ? s(
                                    'div',
                                    {
                                      staticClass: 'loader',
              ...
              t.isOHLC
                ? s(
                    ...
                    [
                      ...
                      s(
                        ...
                        [
                          ...
                          s(
                            ...
                            [
                              s('label', [t._v('Prev. Close')]),
                              t._v(' '),
                              t.ticks[t.token].closePrice
                                ? s(
                                    'a',
                                    {
                                      staticClass: 'value',
                        ...
                        ? s(
                            ...
                            [
                              ...
                              s(
                                ...
                                [
                                  s('label', [t._v('Avg. price')]),
                                  t._v(' '),
                                  t.ticks[t.token].averagePrice
                                    ? s(
                                        'a',
                                        {
                                          staticClass: 'value',
                            ...
                            [
                              ...
                              s(
                                ...
                                [
                                  s('label', [t._v('LTT')]),
                                  t._v(' '),
                                  t.ticks[t.token].lastTradedTime
                                    ? s(
                                        'span',
                                        {
                                          staticClass: 'value',
                      ...
                      t._v(' '),
                      !t.instrument.tradable ||
                      ('OPT' !== t.instrument.type &&
                        'FUT' !== t.instrument.type)
                        ? t._e()
                        : s(
                            'div',
                            {
                      ...
                      t._v(' '),
                      t.circuitLimits &&
                      t.circuitLimits.lower &&
                      t.circuitLimits.upper
                        ? s(
                            'div',
                            {
                              staticClass: 'row',
                            ...
                            [
                              s(
                                ...
                                [
                                  s('label', [
                                    t._v(
                                      t._s(t.instrument.underlying.niceName)
                                    ),
                                  ]),
                                  t._v(' '),
                                  t.ticks[t.underlyingToken].lastPrice
                                    ? s(
                                        'span',
                                        {
                                          directives: [
      ...
      var d = {
          ...
          computed: {
            ...
            underlyingToken() {
              return (
                this.data.instrument.underlying &&
                this.data.instrument.underlying.instrumentToken
              );
            },
            tag() {
            ...
            isDepthLoaded() {
              return (
                ...
                this.ticks[this.token] &&
                this.ticks[this.token].depth &&
                this.ticks[this.token].depth.buy
              );
            },
            isExtendedDepthLoaded() {
              return (
                ...
                this.instrument.tradable &&
                this.ticks[this.token] &&
                this.ticks[this.token].extendedDepth &&
                this.ticks[this.token].extendedDepth.buy
              );
            },
            isExtendedDepth() {
            ...
            isExtendedDepthAvailable() {
              return (
                !(!this.reactive.extendedTicker || !this.instrument) &&
                'NSE' === this.instrument.exchange &&
                !this.instrument.auctionNumber
              );
            },
            isOHLC() {
              return (
                ...
                (this.isDepthLoaded ||
                  (this.instrument &&
                    this.ticks[this.token] &&
                    this.ticks[this.token].closePrice))
              );
            },
            isLoader() {
              return this.instrument && !this.instrument.tradable
                ? !this.isOHLC
                : !this.isDepthLoaded;
            },
            depth() {
              return this.depthType === l && this.isExtendedDepthLoaded
                ? this.ticks[this.token][l]
                : this.ticks[this.token][c];
            },
          },
          created() {
          ...
          watch: {
            data(t, e) {
              e.instrument.instrumentToken !== t.instrument.instrumentToken &&
                (this.unsubscribe(
                  e.instrument.instrumentToken,
                  e.instrument.underlying &&
                    e.instrument.underlying.instrumentToken
                ),
                this.subscribe(
                  t.instrument.instrumentToken,
                  t.instrument.underlying &&
                    t.instrument.underlying.instrumentToken
                ),
          ...
          methods: {
            unsubscribe(t, e) {
              this.ticker.setMode(this.ticker.modeLTPC, [t], this.tag),
                ...
                this.reactive.extendedTicker &&
                  this.reactive.extendedTicker.unsubscribe([t], this.tag),
            ...
            subscribe(t, e) {
              this.ticker.subscribe([t], this.tag),
                ...
                e &&
                  (this.ticker.subscribe([e], this.tag),
                  this.ticker.setMode(this.ticker.modeLTP, [e], this.tag)),
                this.reactive.extendedTicker &&
                  this.depthType === l &&
                  (this.reactive.extendedTicker.subscribe([t], this.tag),
                  this.reactive.extendedTicker.setMode(
                    this.reactive.extendedTicker.modeFull,
                    [t],
                    this.tag
                  ));
            },
            getCircuitLimits(t) {
              this.ticker
                .getQuote(
                  t.toString(),
                  [t],
                  ['lower_circuit_limit', 'upper_circuit_limit', 'expiry']
                )
                .then((t) => {
                  t &&
                    null !== t[0] &&
            ...
            openOrderWindow(t, e, s) {
              ...
              let n = {
                ...
                price: s,
                lastPrice:
                  this.ticks[e.instrumentToken] &&
                  this.ticks[e.instrumentToken].lastPrice,
              };
              this.data.order &&
                (n = {
                  ...n,
            ...
            weightedBG(t, e, s, n) {
              ...
              for (let o = 0; o < e.length; o++)
                a > e[o][s] && (a = e[o][s]), i < e[o][s] && (i = e[o][s]);
              let r = 0.05;
              return (
                a !== i && ((r = (t - a) / (i - a)), 0 === r && (r = 0.05)),
            ...
            toggleDepthType() {
              this.depthType === l
                ? ((this.depthType = c),
                  this.reactive.extendedTicker &&
                    this.reactive.extendedTicker.unsubscribe(
                      [this.token],
                      this.tag
                    ),
                ...
                : this.reactive.extendedTicker &&
                  ((this.depthType = l),
                  this.reactive.extendedTicker.subscribe(
                    [this.token],
                    this.tag
                  ),
                  this.reactive.extendedTicker.setMode(
    ...
    '63ad': function (t, e, s) {
      ...
      s.d(e, 'b', function () {
        ...
        (e['a'] = function (t, e, s) {
          (t.prototype = e.prototype = s), (s.constructor = t);
        });
    },
    '6cd4': function (t, e, s) {
      'use strict';
      ...
      e['a'] = function (t) {
        var e = (t += ''),
          s = e.indexOf(':');
        return (
          s >= 0 && 'xmlns' !== (e = t.slice(0, s)) && (t = t.slice(s + 1)),
        ...
        i = Object(n['a'])(
          ...
          function (t, e) {
            return (
              (e -
                t -
                (e.getTimezoneOffset() - t.getTimezoneOffset()) * a['c']) /
              a['a']
            );
          },
          function (t) {
    ...
    '7c2a': function (t, e, s) {
      ...
      var n = function () {
          ...
          return s(
            ...
            [
              t.positionsConstraints.showHeader
                ? s(
                    'header',
                    {
                    ...
                    [
                      s(
                        ...
                        [
                          s('span', [t._v('Positions')]),
                          t._v(' '),
                          t.positionsConstraints.isFetching
                            ? s('su-loader', {
                                staticClass: 'dim',
                                attrs: {
                                  size: 8,
                ...
                : t._e(),
              t._v(' '),
              t.positionsConstraints.showEmptyState
                ? s(
                    'empty-state',
                    {
                      attrs: {
                        image: t.getStatic(
                          t.appendThemeName(
                            'images/illustrations/positions.svg'
                          )
                        ),
                        showOmnisearch: '',
                    ...
                    [
                      s(
                        ...
                        [s('p', [t._v("You don't have any positions yet")])]
                      ),
                      t._v(' '),
                      s(
                        'div',
                            ...
                            s(
                              'a',
                              {
                                ...
                                attrs: {
                                  ...
                                  href:
                                    t.consoleURL +
                                    '/portfolio/positions?src=kiteweb',
                                },
                              },
                              [
                                s('img', {
                          ...
                          s(
                            ...
                            [
                              t.positionsConstraints.isFetching
                                ...
                                : t._e(),
                              t._v(' '),
                              t.positionsConstraints.isError
                                ? s(
                                    'span',
                                    {
                                      directives: [
                ...
                : t._e(),
              t._v(' '),
              t.positionsConstraints.showErrorState
                ? s('error-state', {
                    attrs: {
              ...
              t.positionsConstraints.isData
                ? s(
                    ...
                    [
                        ...
                        [
                          s(
                            ...
                            [
                              ...
                              t._v(' '),
                              t.positionsConstraints.showErrorIcon
                                ? s(
                                    'span',
                                    {
                                      directives: [
                      ...
                      t._v(' '),
                      t.netData && t.netData.length > 0 && t.isMobile
                        ? s(
                            'div',
                            {
                              staticClass: 'cards',
                                ...
                                [
                                  s(
                                    ...
                                    [
                                      ...
                                      t._v(' '),
                                      s('span', [t._v('Analytics')]),
                                    ]
                                  ),
                                ]
                              ),
                              t._v(' '),
                              t._l(t.netData, function (e, n) {
                                return s(
                                  'div',
                                  {
                                    key: n,
                                        ...
                                        s(
                                          ...
                                          [
                                            s(
                                              ...
                                              {
                                                staticClass:
                                                  'text-label small aqua product-label',
                                                class: {
                                          ...
                                          return [
                                            ...
                                            s(
                                              ...
                                              [
                                                ...
                                                s(
                                                  ...
                                                  {
                                                    staticClass:
                                                      'exchange text-xxsmall dim',
                                                  },
                                                  [t._v(t._s(e.row.exchange))]
                                                ),
                                                t._v(' '),
                                                'CNC' === e.row.product &&
                                                0 !== e.row.quantity
                                                  ? s(
                                                      ...
                                                      {
                                                        staticClass:
                                                          'holding-tag text-label text-label-outline',
                                                      },
                                                      [
                                                        e.row.quantity > 0
                                                          ? s(
                                                              'a',
                                                              {
                                                                ...
                                                                attrs: {
                                                                  title:
                                                                    'Stock will show under Holdings tomorrow',
                                                        ...
                                                        e.row.quantity < 0
                                                          ? s(
                                                              'a',
                                                              {
                                                                ...
                                                                attrs: {
                                                                  title:
                                                                    'Stock will disappear from holdings tomorrow and funds can be withdrawn after 2 days.',
                                            ...
                                            s(
                                              'td',
                                              {
                                                class: [
                                                  e.row.style.pnl,
                                                  t.positionsColumnStyles.pnl,
                                                ],
                                              },
                                              [
                                                0 === e.row.average_price &&
                                                0 !== e.row.quantity
                                                  ? s('span', [t._v('N/A')])
                                                  : s('span', [
                                                      t._v(
                ...
                : t._e(),
              t._v(' '),
              !t.minimal && t.positionsConstraints.isDayPositions
                ? s(
                    'section',
                    {
                        ...
                        [
                          s(
                            ...
                            [
                              ...
                              t._v(' '),
                              s('span', [
                                t._v('(' + t._s(t.positions.day.length) + ')'),
                              ]),
                              t._v(' '),
                              t.positionsConstraints.showErrorIcon
                                ? s(
                                        ...
                                        s(
                                          ...
                                          [
                                            s(
                                              ...
                                              {
                                                staticClass:
                                                  'text-label small aqua order-status-label',
                                                class: {
                                                  indigo: 'NRML' == e.product,
                                                  amber: 'MIS' == e.product,
                                                  'sienna-brown':
                ...
                : t._e(),
              t._v(' '),
              !t.minimal && t.positionsConstraints.isData
                ? s(
                    'section',
                    {
                ...
                : t._e(),
              t._v(' '),
              t.positionsInfo && t.currentPosition
                ? s('position-info', {
                    directives: [
                      {
                        name: 'on-escape',
                ...
                : t._e(),
              t._v(' '),
              t.productModifyModal && t.currentPosition
                ? s('product-modify', {
                    directives: [
                      {
                        name: 'on-escape',
                ...
                [
                      ...
                      s(
                        ...
                        [
                          s(
                            ...
                            {
                              staticClass:
                                'text-label text-label-outline small position-status-label',
                              class: {
                              ...
                              s(
                                ...
                                [
                                  s(
                                    ...
                                    [s('label', [t._v('Carry forward qty.')])]
                                  ),
                                  t._v(' '),
                                  s(
                                    'div',
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.averagePrice
                                        ? s(
                                            'div',
                                            {
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.lastPrice
                                        ? s(
                                            'div',
                                            {
                                              staticClass: 'last-price',
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.closePrice
                                        ? s(
                                            'div',
                                            {
                                              staticClass: 'last-price',
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.buyQuantity
                                        ? s(
                                            'div',
                                            {
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.sellQuantity
                                        ? s(
                                            'div',
                                            {
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.sellPrice
                                        ? s(
                                            'div',
                                            {
                              ...
                              s(
                                ...
                                [
                                  ...
                                  s(
                                    ...
                                    [
                                      t.position.formatted.sellValue
                                        ? s(
                                            'div',
                                            {
                  ...
                  s(
                    ...
                    [
                      ...
                      t._v(' '),
                      0 !== t.position.quantity &&
                      'BO' !== t.position.product &&
                      'CO' !== t.position.product
                        ? s(
                            'su-button',
                            {
                              staticClass: 'button-outline button-blue',
        ...
        b = {
          ...
          methods: {
            ...
            add() {
              this.$emit('add'), this.close();
            },
            exit() {
              this.$emit('exit'), this.close();
            },
            modify() {
              this.$emit('modify');
            },
                ...
                [
                      ...
                      s(
                        ...
                        [
                          s(
                            ...
                            [
                              t.position.instrument &&
                              t.position.instrument.niceName
                                ? s('span', [
                                    t._v(
                                      '\n\t\t\t\t\t' +
                                ...
                                : s('span', [
                                    t._v(t._s(t.position.tradingsymbol)),
                                  ]),
                              t._v(' '),
                              s(
                                'span',
                  ...
                  s(
                    ...
                    [
                            ...
                            [
                              ...
                              s(
                                ...
                                [
                                  s('label', [t._v('Product')]),
                                  t._v(' '),
                                  s('span', [t._v(t._s(t.position.product))]),
                                  t._v(' '),
                                  s('span', {
                                    staticClass: 'icon icon-arrow-right',
                                  }),
                                  t._v(' '),
                                  s('span', [t._v(t._s(t.toProduct))]),
                                ]
                              ),
                              t._v(' '),
                              s(
                                ...
                                [
                                      ...
                                      directives: [
                                        {
                                          ...
                                          rawName: 'v-show',
                                          value:
                                            t.convertibleQuantity !=
                                            t.position.instrument.lotSize,
                                          expression:
                                            'convertibleQuantity != position.instrument.lotSize',
                                        },
                                      ],
                                    },
                                    [
                                      s('label', [t._v('Quantity')]),
                                      t._v(' '),
                                      s('su-input', {
                                        attrs: {
                                          type: 'number',
                                  ...
                                  s(
                                    ...
                                    [
                                      ...
                                      t._v(' '),
                                      s('span', [
                                        t._v(t._s(t.convertibleQuantity)),
                                      ]),
                                    ]
                                  ),
                                ]
                      ...
                      t._v(' '),
                      t.isHoldingsAuthShown
                        ? s('holdings-auth-confirm', {
                            on: {
        ...
        M = {
          ...
          methods: {
            ...
            getToProduct(t, e) {
              return t === f['b'].PRODUCT.CNC || t === f['b'].PRODUCT.NRML
                ? f['b'].PRODUCT.MIS
                : e === f['b'].EXCHANGES.NSE || e === f['b'].EXCHANGES.BSE
                ? f['b'].PRODUCT.CNC
                : f['b'].PRODUCT.NRML;
            },
            changeType(t) {
              'DAY' === this.type
                ? ((this.convertibleQuantity = Math.abs(this.dayQuantity)),
                  (this.convertQuantity = Math.abs(this.dayQuantity)),
                  (this.transactionType =
                    this.dayQuantity > 0
                      ? f['b'].TRANSACTION_TYPE.BUY
                      : f['b'].TRANSACTION_TYPE.SELL))
                : ((this.convertibleQuantity = Math.abs(
                    this.position.overnight_quantity
                  )),
                  (this.convertQuantity = Math.abs(
                    this.position.overnight_quantity
                  )),
                  (this.transactionType =
                    this.position.overnight_quantity > 0
                      ? f['b'].TRANSACTION_TYPE.BUY
                      : f['b'].TRANSACTION_TYPE.SELL));
            },
            setUp(t) {
              (this.type = 'DAY'),
                ...
                0 === t.overnight_quantity
                  ? ((this.types = ['DAY']), (this.type = 'DAY'))
                  : 0 === this.dayQuantity &&
                    ((this.types = ['OVERNIGHT']), (this.type = 'OVERNIGHT')),
                this.changeType(this.type);
            },
            modifyProduct() {
              this.$refs['productForm'].validate() &&
                this.apiProductModify({
            ...
            apiProductModify(t) {
              (this.productModifyInProgress = !0),
                E['a']
                  ...
                  .catch((t) => {
                    (this.productModifyInProgress = !1),
                      t && t.response && 428 === t.response.status
                        ? this.showHoldingsAuth()
                        : this.$toast.error({
        ...
        L = {
          ...
          computed: {
            ...
            ...Object(i['d'])(h['b'], [
              'positions',
              'positionsFetchStatus',
              'positionsError',
            ]),
            positionsConstraints() {
              let t =
                  this.positionsFetchStatus === r['d'].API_STATUSES.fetching,
                e = this.positionsFetchStatus === r['d'].API_STATUSES.error,
                s =
                  this.positions &&
                  this.positions.net &&
                  this.positions.net.length > 0,
                n =
                  this.positions &&
                  this.positions.day &&
                  this.positions.day.length > 0,
                a =
                  this.positions &&
                  this.positions.net &&
                  0 === this.positions.net.length,
            ...
            openPositionsCount() {
              if (this.positionsConstraints.isData)
                return this.positions.net.filter((t) => 0 !== t.quantity)
                  .length;
            },
            netPnl() {
              return this.netData && this.netData.length > 0
                ? this.netData.reduce((t, e) => t + e.pnl, 0)
                : 0;
            },
            dayPnl() {
              return this.dayData && this.dayData.length > 0
                ? this.dayData.reduce((t, e) => t + e.pnl, 0)
                : 0;
            },
            isAnalyzeWidget() {
          ...
          watch: {
            ...
            ticks(t, e) {
              if (this.performanceMode || !this.isComponentActive) return;
              let s = !0;
              ...
              s && (this.updateDayPositions(t), this.updateNetPositions(t));
            },
          },
          methods: {
            ...
            postProcess() {
              (this.isComponentActive = !1),
                ...
                this.subscribedTokens &&
                  this.subscribedTokens.length > 0 &&
                  this.ticker.unsubscribe(this.subscribedTokens, h['b']),
            ...
            calculate_ExactPL(bp, sp, qty, h) {
              ...
              let stt_total = Math.round(
                parseFloat(parseFloat(sp * qty * 0.000625).toFixed(2))
              );
              ...
              var nse_ipft = parseFloat(
                parseFloat(0.000005 * turnover).toFixed(2)
              );
              etc = parseFloat(parseFloat(etc + nse_ipft).toFixed(2));

              let stax = parseFloat(
                parseFloat(0.18 * (brokerage + etc + sebi_charges)).toFixed(2)
              );
              ...
              let breakeven = parseFloat(
                parseFloat(total_tax / qty).toFixed(2)
              );
              ...
              return {
                ...
                netProfit,
                breakeven,
                isInProfit: parseFloat(netProfit) > 0,
              };
            },
            initUpdateTimer() {
              this.clearUpdateTimer();
            ...
            updateAllPositions(t) {
              let e = [];
              for (let s of t.net) e.push(s.instrument_token);
              (this.subscribedTokens = e),
                ...
                t &&
                  t.net &&
                  t.net.length > this.maxItems &&
                  ((this.performanceMode = !0), this.initUpdateTimer()),
                this.updateDayPositions(this.ticks),
                this.updateNetPositions(this.ticks);
            },
            updateDayPositions(t) {
              this.positions &&
                this.positions.day &&
                this.positions.day.length > 0 &&
                (this.dayData = this.updatePositions(t, this.positions.day));
            },
            updateNetPositions(t) {
              this.positions &&
                this.positions.net &&
                this.positions.net.length > 0 &&
                (this.netData = this.updatePositions(t, this.positions.net));
            },
            getInstrument(t) {
              let e = this.instruments[t.instrument_token];
              return (
                e ||
                  ((e = this.instrumentManager.get(
                    t.tradingsymbol,
                    null,
                    t.exchange
                  )),
            ...
            updatePositions(t, e) {
              ...
              for (let a of e) {
                ...
                (0 === a.sell_value && 0 === a.buy_value) ||
                  (0 === a.sell_price && 0 === a.buy_price) ||
                  (r =
                    a.sell_value - a.buy_value + a.quantity * d * a.multiplier),
                  (0 === a.sell_m2m && 0 === a.buy_m2m) ||
                    (0 === a.sell_price && 0 === a.buy_price) ||
                    (l =
                      a.sell_m2m - a.buy_m2m + a.quantity * d * a.multiplier),
                  0 !== a.average_price &&
                    (i = ((d - a.average_price) / a.average_price) * 100),
                  0 === a.average_price &&
                    0 !== a.quantity &&
                    ((r = 0), (l = 0)),
                  (h.JS_REAL_PL = this.calculate_ExactPL(
                    a.buy_price || a.last_price,
                    a.sell_price || a.last_price,
                    a.quantity,
                    a
                  )),
                  (h.uid = e),
                ...
                (h.averagePrice = Object(o['c'])(a.average_price, f)),
                  ...
                  p && p.expiryWeek && p.niceName
                    ? (h.niceName = Object(c['a'])(p.niceName))
                    : (h.niceName = p && p.niceName),
                  (h.formatted = {
                    ...
                    changePercent:
                      Object(o['b'])(i, 2, !0) +
                      `%  ${h.JS_REAL_PL?.actualNetProfit || 0}`,
            ...
            showPositionsInfo(t) {
              (this.positionsInfo = !0), (this.currentPosition = t);
            },
            hidePositionsInfo() {
              (this.positionsInfo = !1), (this.currentPosition = null);
            },
            showProductModify(t) {
            ...
            hideProductModify(t) {
              (this.productModifyModal = !1), (this.currentPosition = null);
            },
            textStyle(t) {
              return {
                'text-red': t < 0,
            ...
            quantityStyle(t) {
              return {
                ...
                greyed:
                  0 === t.quantity ||
                  (t.quantity < 0 && t.product === f['b'].PRODUCT.CNC),
                open: 0 !== t.quantity,
              };
            },
            ...
            addPosition(t) {
              ...
              let s =
                  t.quantity >= 0
                    ...
                    : f['b'].TRANSACTION_TYPE.SELL,
                n =
                  this.ticks[t.instrument_token] &&
                  this.ticks[t.instrument_token].lastPrice,
                a = t.product;
              (a !== f['b'].VARIETY.CO.toUpperCase() &&
                a !== f['b'].VARIETY.BO.toUpperCase()) ||
                (a = f['b'].PRODUCT.MIS),
                this.placeOrder({
                  instrument: e,
            ...
            exitPosition(t) {
              ...
              if (e)
                if (
                  'CO' === t.product.toUpperCase() ||
                  'BO' === t.product.toUpperCase()
                ) {
                  let t = this.$toast.TOP_RIGHT;
                  this.minimal
                    ? (t = this.$toast.BOTTOM_LEFT)
                    : this.$router.push(l['b'].orders),
                    this.$toast.warning({
            ...
            calCustomExitPrice(buyOrSell, n, t) {
              if (buyOrSell === 'BUY') {
                if (t.JS_REAL_PL?.isInProfit) return n;
                  ...
                  let minPrice = t.sell_price - (t.JS_REAL_PL?.breakeven || 0);
              ...
              if (buyOrSell === 'SELL') {
                if (t.JS_REAL_PL?.isInProfit) return n;
                  ...
                  let minPrice = t.buy_price - (t.JS_REAL_PL?.breakeven || 0);
      ...
      var n = function () {
          ...
          return s(
            ...
            [
              ...
              t._v(' '),
              (t.data && t.data.length > t.maxItems) ||
              (t.rawData && t.rawData.length > t.maxItems)
                ? s(
                    'div',
                    {
          ...
          methods: {
            ...
            formatRawData(t) {
              ...
              for (let s = 0; s < t.length; s++) {
                if (0 === t[s].average_price && 0 !== t[s].quantity) continue;
                let n = this.instrumentManager.get(
                    t[s].tradingsymbol,
                    null,
                    t[s].exchange
                  ),
                  a = '';
                (a = n
                  ? n.niceName + ' (' + t[s].product + ')'
                  : t[s].tradingsymbol + ' (' + t[s].product + ')'),
                  e.push({
                    pnl: t[s].pnl,
              ...
              if (
                ((e = Object(l['o'])(e, 'pnl', !0)), e.length > this.maxItems)
              ) {
            ...
            draw(t, e, s) {
              ...
              let n = 10,
                ...
                u = t
                  ...
                  .style('width', l + 'px')
                  .style('height', i + 'px'),
                d = Object(o['d'])().exponent(0.5).range([0, l]),
                h = Object(o['a'])().rangeRound([i, 0]),
                p = Object(r['d'])(e, (t) => parseFloat(t.pnl));
              Math.abs(p[0]) >= Math.abs(p[1]) &&
                (p = [-Math.abs(p[0]), Math.abs(p[0])]),
                Math.abs(p[1]) > Math.abs(p[0]) &&
                  (p = [-Math.abs(p[1]), Math.abs(p[1])]),
                d.domain(p).nice(),
              ...
              f
                ...
                .style('left', (t) => d(Math.min(0, t.pnl)) + 'px')
                .style('top', (t) => h(t.label) + a + 'px')
                .style(
                  'width',
                  (t) => Math.max(Math.abs(d(t.pnl) - d(0)), 2) + 'px'
                )
                .style('height', n + 'px')
                ...
                f
                  ...
                  .style('position', 'absolute')
                  .style('left', (t) =>
                    t.pnl > 0 ? '0px' : t.pnl <= 0 ? d(0) + 'px' : void 0
                  )
                  .style('text-align', (t) => {
                    if (t.pnl > 0) return 'right';
                  })
                  .style('top', (t) => h(t.label) + a + 'px')
                  .style('width', (t) =>
                    t.pnl > 0
      ...
      e['a'] = function (t, e) {
        ...
        while ((s = a.exec(t)) && (c = i.exec(e)))
          (l = c.index) > u &&
            ...
            (u = i.lastIndex);
        return (
          u < e.length && ((l = e.slice(u)), h[d] ? (h[d] += l) : (h[++d] = l)),
          h.length < 2
            ? p[0]
              ? o(p[0].x)
              : r(e)
            : ((e = p.length),
              function (t) {
                for (var s, n = 0; n < e; ++n) h[(s = p[n]).i] = s.x(t);
                return h.join('');
              })
        );
      };
        ...
        for (let a = 0; a < t.length; a++) {
          ...
          if (i.expiry)
            try {
              ...
              let r = new Date();
              r > n ? ((s = !0), e.push(t[a])) : e.push(i);
            } catch (n) {
              e.push(i);
            }
          else e.push(i);
        }
        return s && Object(o['d'])(l, 'pinnedInstruments', e), e;
      }
      const h = {
          ...
          priceChangeType:
            Object(o['b'])(l, 'priceChangeType') ||
            a['b'].CLOSE_ABSOLUTE_PERCENTAGE,
        ...
        f = {
          setCurrentWatchId(t, e) {
            (t.currentWatchId = e), Object(o['d'])(l, 'currentWatchId', e);
          },
          ...
          setPriceChangeType(t, e) {
            (t.priceChangeType = e), Object(o['d'])(l, 'priceChangeType', e);
          },
          setShowPriceChange(t, e) {
            (t.showPriceChange = e), Object(o['d'])(l, 'showPriceChange', e);
          },
          setShowHoldings(t, e) {
            (t.showHoldings = e), Object(o['d'])(l, 'showHoldings', e);
          },
          setShowDirection(t, e) {
            (t.showDirection = e), Object(o['d'])(l, 'showDirection', e);
          },
          pinInstrument(t, e) {
    ...
    b055: function (t, e, s) {
      ...
      function r(t, e) {
        var s = e - t;
        return s
          ? a(t, s > 180 || s < -180 ? s - 360 * Math.round(s / 360) : s)
          : Object(n['a'])(isNaN(t) ? e : t);
      }
      function o(t) {
        return 1 === (t = +t)
          ? c
    ...
    bc17: function (t, e, s) {
      ...
      var l = function (t) {
        ...
        m = function (t, e, s) {
          var n,
            ...
            r,
            o = -1;
          if (((e = +e), (t = +t), (s = +s), t === e && s > 0)) return [t];
          if (
            ((n = e < t) && ((a = t), (t = e), (e = a)),
      ...
      function _(t, e, s) {
        var n = (e - t) / Math.max(0, s),
          ...
          i = n / Math.pow(10, a);
        return a >= 0
          ? (i >= p ? 10 : i >= f ? 5 : i >= v ? 2 : 1) * Math.pow(10, a)
          : -Math.pow(10, -a) / (i >= p ? 10 : i >= f ? 5 : i >= v ? 2 : 1);
      }
      function g(t, e, s) {
        var n = Math.abs(e - t) / Math.max(0, s),
          ...
          i = n / a;
        return (
          i >= p ? (a *= 10) : i >= f ? (a *= 5) : i >= v && (a *= 2),
          e < t ? -a : a
        );
      }
      var b = function (t, e, s) {
          if ((null == s && (s = l), (n = t.length))) {
            if ((e = +e) <= 0 || n < 2) return +s(t[0], 0, t);
            if (e >= 1) return +s(t[n - 1], n - 1, t);
            var n,
              a = (n - 1) * e,
              i = Math.floor(a),
              r = +s(t[i], i, t),
        ...
        y = function (t, e) {
          ...
          if (null == e) {
            while (++i < a)
              if (null != (s = t[i]) && s >= s) {
                n = s;
                while (++i < a) null != (s = t[i]) && s > n && (n = s);
              }
          } else
            while (++i < a)
              if (null != (s = e(t[i], i, t)) && s >= s) {
                n = s;
                while (++i < a) null != (s = e(t[i], i, t)) && s > n && (n = s);
              }
          return n;
        },
        C = function (t, e) {
          ...
          if (null == e) {
            while (++i < a)
              if (null != (s = t[i]) && s >= s) {
                n = s;
                while (++i < a) null != (s = t[i]) && n > s && (n = s);
              }
          } else
            while (++i < a)
              if (null != (s = e(t[i], i, t)) && s >= s) {
                n = s;
                while (++i < a) null != (s = e(t[i], i, t)) && n > s && (n = s);
              }
          return n;
        };
    },
    bfdc: function (t, e, s) {
      ...
      var n = function () {
          ...
          return s(
            ...
            [
              t.ordersConstraints.showErrorState
                ? s('error-state', {
                    attrs: {
                ...
                : t._e(),
              t._v(' '),
              t.ordersConstraints.showEmptyState
                ? s(
                    'empty-state',
                    {
                      attrs: {
                        image: t.getStatic(
                          t.appendThemeName(
                            'images/illustrations/orderbook.svg'
                          )
                        ),
                        showOmnisearch: '',
                        omnisearchActionTitle: 'Get started',
                    ...
                    [
                      s(
                        ...
                        [s('p', [t._v("You haven't placed any orders today")])]
                      ),
                      t._v(' '),
                      s(
                        'div',
                        ...
                        [
                          ...
                          s(
                            'div',
                            [
                              t.ordersConstraints.isFetching
                                ? s('su-loader', {
                                    staticClass: 'dim',
                                    attrs: {
                                      size: 8,
                ...
                ? s(
                    ...
                    [
                      s(
                        ...
                        [s('p', [t._v("You don't have any open orders")])]
                      ),
                    ]
                  )
                : t._e(),
              t._v(' '),
              t.ordersConstraints.showHeader
                ? s(
                    'div',
                    {
                ...
                : t._e(),
              t._v(' '),
              t.ordersConstraints.isData && t.ordersConstraints.isPendingOrders
                ? s(
                    'section',
                    {
                          ...
                          s(
                            ...
                            [
                              ...
                              s(
                                ...
                                [t._v('(' + t._s(t.pendingOrders.length) + ')')]
                              ),
                              t._v(' '),
                              t.ordersConstraints.showErrorIcon
                                ? s(
                                    'span',
                                    {
                                      directives: [
                                  ...
                                  s(
                                    ...
                                    [
                                      s(
                                        ...
                                        [
                                          'SELL' === e.transaction_type
                                            ? s(
                                                'span',
                                                {
                                                  staticClass:
                                                    'text-label text-label-outline red small',
                                                },
                                                [t._v('SELL')]
                                              )
                                            : t._e(),
                                          t._v(' '),
                                          'BUY' === e.transaction_type
                                            ? s(
                                                'span',
                                                {
                                                  staticClass:
                                                    'text-label text-label-outline blue small',
                                                },
                                                [t._v('BUY')]
                                              )
                                            : t._e(),
                                          ...
                                          s(
                                            ...
                                            {
                                              staticClass:
                                                'text-label text-label-outline small order-status-label',
                                              class: {
                        ...
                        : s(
                            ...
                            [
                              s(
                                          ...
                                          return [
                                            ...
                                            s(
                                              ...
                                              [
                                                ...
                                                t._v(' '),
                                                'auction' === e.row.variety &&
                                                e.row.auction_number
                                                  ? s('span', [
                                                      s(
                                                        'span',
                                                        {
                                                        ...
                                                        s(
                                                          ...
                                                          [
                                                            s(
                                                              ...
                                                              {
                                                                staticClass:
                                                                  'icon icon-iceberg text-light text-xsmall',
                                                              },
                                                              [
                                                                t._v(
                                                                  '\n\t\t\t\t\t\t\t\t\t' +
                                              ...
                                              [
                                                ...
                                                s(
                                                  ...
                                                  [
                                                    s('span', {
                                                      staticClass:
                                                        'icon icon-alert-triangle text-red status-message-info',
                                                    }),
                                                  ]
                                                ),
                                                t._v(' '),
                                ...
                                [
                                  t._v(' '),
                                  t.selectedPendingOrders.length > 0
                                    ? s(
                                        'tr',
                                        {
                                          attrs: {
                ...
                : t._e(),
              t._v(' '),
              !t.minimal && t.ordersConstraints.isCompletedOrders
                ? s(
                    'section',
                    {
                              ...
                              s(
                                'su-table',
                                {
                                  ...
                                  attrs: {
                                    ...
                                    toolbar:
                                      t.formattedCompletedOrders &&
                                      0 !== t.formattedCompletedOrders.length,
                                    'search-place-holder':
                                      'eg: sell, nifty, nrml etc.',
                                              ...
                                              [
                                                ...
                                                e.row.transaction_type
                                                  ? s(
                                                      ...
                                                      {
                                                        staticClass:
                                                          'text-label red small',
                                                      },
                                                      [t._v('SELL')]
                                                    )
                                                  : t._e(),
                                                t._v(' '),
                                                'BUY' === e.row.transaction_type
                                                  ? s(
                                                      'span',
                                                      {
                                                        staticClass:
                                                          'text-label blue small',
                                                      },
                                                      [t._v('BUY')]
                                                    )
                                                  : t._e(),
                ...
                : t._e(),
              t._v(' '),
              !t.minimal && t.ordersConstraints.isData
                ? s(
                    'section',
                    {
                    ...
                    [
                        ...
                        [
                          s(
                            ...
                            [
                              ...
                              t._v(' '),
                              t.showTrades && t.tradesConstraints.isData
                                ? s('span', [
                                    t._v('(' + t._s(t.trades.length) + ')'),
                                  ])
                                : t._e(),
                              t._v(' '),
                              t.tradesConstraints.isFetching
                                ? s('su-loader', {
                                    staticClass: 'dim',
                                    attrs: {
                                      size: 8,
                      ...
                      t._v(' '),
                      t.showTrades && t.tradesConstraints.showEmptyState
                        ? s(
                            'empty-state',
                            {
                              attrs: {
                            ...
                            [
                              s(
                                ...
                                [
                                  s('p', [
                                    t._v("You don't have any trades today"),
                                  ]),
                                ]
                              ),
                              t._v(' '),
                        ...
                        : t._e(),
                      t._v(' '),
                      t.showTrades && t.tradesConstraints.showErrorState
                        ? s('error-state', {
                            attrs: {
                        ...
                        : t._e(),
                      t._v(' '),
                      t.showTrades && t.tradesConstraints.isData && t.isMobile
                        ? s(
                            'div',
                            {
                                      ...
                                      s(
                                        ...
                                        [
                                          s(
                                            ...
                                            [
                                              t._v(
                                                t._s(e.fill_timestamp.slice(11))
                                              ),
                                            ]
                                          ),
                                        ]
                        ...
                        s(
                          ...
                          [
                            s(
                              ...
                              {
                                staticClass:
                                  'eight columns tradingsymbol-wrapper',
                              },
                              [
                                s(
                                  'span',
                                  {
                                    staticClass:
                                      'transaction-type text-label text-label-outline blue',
                                    class: {
                                ...
                                s(
                                  ...
                                  [
                                    ...
                                    s(
                                      ...
                                      [t._v(t._s(t.order.exchange))]
                                    ),
                                    t._v(' '),
                                    t.order.auction_number
                                      ? s(
                                          'span',
                                          {
                                            staticClass:
                            ...
                            s(
                              ...
                              [
                                s(
                                  ...
                                  [
                                    'CANCELLED' === t.order.status &&
                                    0 !== t.order.filled_quantity
                                      ? s('span', [t._v('*')])
                                      : t._e(),
                                    t._v(t._s(t.order.status) + '\n\t\t\t\t'),
                                  ]
                                ),
                              ]
                            ),
                            ...
                            s(
                              ...
                              [
                                s(
                                  ...
                                  {
                                    staticClass:
                                      'four columns left mobile-modal',
                                  },
                                  [
                                    s(
                                      'div',
                                          ...
                                          [
                                            ...
                                            0 !== t.order.filled_quantity
                                              ? s(
                                                  ...
                                                  {
                                                    staticClass:
                                                      'text-xxsmall text-light',
                                                  },
                                                  [t._v('*Partially filled')]
                                                )
                                              : t._e(),
                                          ]
                                        ),
                                    ...
                                    s(
                                      ...
                                      [
                                        ...
                                        s(
                                          ...
                                          [
                                            'TTL' === t.order.validity
                                              ? s('span', [
                                                  t._v(
                                                    '\n\t\t\t\t\t\t\t\t' +
                                                      t._s(
                                                        t.order.validity_ttl
                                                      ) +
                                                      ' min(s)\n\t\t\t\t\t\t\t\t'
                                                  ),
                                                  s('span', {
                                            ...
                                            s(
                                              ...
                                              [
                                                t._v(
                                                  '\n\t\t\t\t\t\t\t' +
                                                    t._s(
                                                      t.order.meta.iceberg.leg
                                                    ) +
                                                    ' / ' +
                                                    t._s(
                                                      t.order.meta.iceberg.legs
                                                    ) +
                                                    '\n\t\t\t\t\t\t\t'
                                                ),
                                                s('span', {
                                                  staticClass:
                                                    'icon icon-iceberg text-light',
                                                }),
                                                t._v(' '),
                                                s('br'),
                                                t._v(
                                ...
                                s(
                                  ...
                                  {
                                    staticClass:
                                      'six columns right mobile-modal',
                                  },
                                  [
                                    s(
                                      'div',
                                    ...
                                    t.order.gtt
                                      ...
                                      : t._e(),
                                    t._v(' '),
                                    t.order.status_message
                                      ? s(
                                          'div',
                                          {
                                            staticClass:
                                              'row status-message text-red',
                                          },
                                          [
                                            s('p', {
                                              domProps: {
                            ...
                            'COMPLETE' === t.order.status
                              ? s(
                                  'su-button',
                                  {
                                    ...
                                    nativeOn: {
                                      click: function (e) {
                                        return t.fetchOrderTrades.apply(
                                          null,
                                          arguments
                                        );
                                      },
                  ...
                  t.showOrderTrades
                    ? [
                        ...
                        s(
                          ...
                          [
                            t.orderTrades && t.orderTrades.length > 0
                              ? s(
                                  'div',
                                  {
                                    staticClass: 'trades',
                                              ...
                                              return [
                                                ...
                                                s('td', [
                                                  t._v(
                                                    '\n\t\t\t\t\t\t\t' +
                                                      t._s(
                                                        e.row.exchange_timestamp.slice(
                                                          11
                                                        )
                                                      ) +
                                                      '\n\t\t\t\t\t\t'
                        ...
                        s(
                          ...
                          [
                            s(
                              ...
                              {
                                staticClass:
                                  'four columns tradingsymbol-wrapper',
                              },
                              [
                                s(
                                  'span',
                            ...
                            s(
                              ...
                              {
                                staticClass:
                                  'status eight columns tradingsymbol-wrapper',
                              },
                              [
                                s(
                                  'h3',
                                                ...
                                                s('td', [
                                                  e.row
                                                    ...
                                                    ? s('span', [
                                                        t._v(
                                                          t._s(
                                                            e.row.exchange_update_timestamp.slice(
                                                              11
                                                            )
                                                          )
                                                        ),
        ...
        b = {
          ...
          computed: {
            ...Object(i['d'])(['isMobile']),
            isApiFetching() {
              if (this.currentFetchStatus === c['b'].fetching) return !0;
            },
            isApiFetchFailed() {
              if (this.currentFetchStatus === c['b'].error) return !0;
            },
          },
          methods: {
            show() {
            ...
            init(t) {
              (this.order = t), this.showOnlyOrder(), this.show();
            },
            showOnlyOrder() {
            ...
            fetchOrderTrades(t) {
              this.currentFetchStatus !== c['b'].fetching &&
                ...
                (this.currentFetchStatus = c['b'].fetching),
                _['a']
                  .getOrderTrades(this.order.order_id)
                  .then((t) => {
            ...
            ? s(
                ...
                [
                  s(
                    ...
                    [s('h2', [t._v('Virtual contract note')])]
                  ),
                  t._v(' '),
                  s(
                    'div',
                        ...
                        ? s(
                            ...
                            [
                              s(
                                ...
                                [
                                  s('p', [
                                    t._v('There are no completed orders yet'),
                                  ]),
                                ]
                              ),
                            ]
                                  ...
                                  s(
                                    ...
                                    [
                                      t._v(
                                        '\n\t\t\t\t\t\t' +
                                          t._s(
                                            t._f('round')(t.totals.stamp_duty)
                                          ) +
                                          '\n\t\t\t\t\t'
                                      ),
                                    ]
                                    ...
                                    [
                                      t._v(
                                        '\n\t\t\t\t\t\t' +
                                          t._s(
                                            t._f('round')(
                                              t.totals.exchange_turnover_charge
                                            )
                                          ) +
                                          '\n\t\t\t\t\t'
                                      ),
                              ...
                              s(
                                ...
                                [
                                  s(
                                    ...
                                    [s('label', [t._v('SEBI turnover charge')])]
                                  ),
                                  t._v(' '),
                                  s(
                                    'div',
        ...
        O = {
          ...
          methods: {
            ...
            niceName(t, e) {
              ...
              return null !== (s = Object(u['a'])(n.niceName)) && void 0 !== s
                ? s
                : t;
            },
          },
          computed: {
            totals() {
              return {
                transaction_tax: this.charges.reduce(
                  (t, e) => t + e.charges.transaction_tax,
                  0
                ),
                exchange_turnover_charge: this.charges.reduce(
                  (t, e) => t + e.charges.exchange_turnover_charge,
                  0
                ),
                sebi_turnover_charge: this.charges.reduce(
                  (t, e) => t + e.charges.sebi_turnover_charge,
                  0
                ),
                brokerage: this.charges.reduce(
                  (t, e) => t + e.charges.brokerage,
                  0
                ),
                stamp_duty: this.charges.reduce(
                  (t, e) => t + e.charges.stamp_duty,
                  0
                ),
          ...
          computed: {
            ...
            ordersConstraints() {
              let t = this.orderFetchStatus === c['d'].API_STATUSES.fetching,
                ...
                a =
                  s && this.completedOrders && this.completedOrders.length > 0,
            ...
            formattedPendingOrders() {
              ...
              for (let e of this.pendingOrders) {
                let s = !1,
                  ...
                  i =
                    (this.ticks &&
                      ...
                      this.ticks[e.instrument_token].lastPrice) ||
                    0,
                  r = this.instrumentManager.get(
                    e.tradingsymbol,
                    null,
                    e.exchange
                  ),
                ...
                (e.product !== o['b'].VARIETY.BO.toUpperCase() &&
                  e.product !== o['b'].VARIETY.CO.toUpperCase()) ||
                  !e.parent_order_id ||
                  (s = !0),
                  e.product === o['b'].VARIETY.BO.toUpperCase() &&
                    e.order_type === o['b'].ORDER_TYPE.SLM.toUpperCase() &&
                    (n = !0);
                let p,
                  f = {
                ...
                e.meta &&
                  e.meta.gttp &&
                  (p = this.gttMeta(e.meta.gttp, e.transaction_type));
            ...
            formattedCompletedOrders() {
              ...
              for (let e of this.completedOrders) {
                ...
                let i,
                  r = (n && n.precision) || 2,
                  o = Object(l['c'])(e.average_price || e.price || 0, r),
                  c = {
                ...
                e.meta &&
                  e.meta.gttp &&
                  (i = this.gttMeta(e.meta.gttp, e.transaction_type));
            ...
            formattedTrades() {
              ...
              for (let e of this.trades) {
                let s = this.instrumentManager.get(
                    e.tradingsymbol,
                    null,
                    e.exchange
                  ),
            ...
            selectedOrdersType() {
              let t = !1,
                e = !1;
              return (
                this.selectedPendingOrders.forEach((s) => {
                  s.isExit ? (t = !0) : (e = !0);
                }),
          ...
          methods: {
            ...
            preProcess() {
              this.$events.on(c['d'].EVENTS.refetch + d['b'], this.fetchAll),
                this.$events.on(
                  o['b'].EVENTS.ORDER_CANCEL_SUCCESS,
                  this.fetchAll
                ),
                this.$events.on(
                  o['b'].EVENTS.ORDER_CANCEL_ERROR,
                  this.fetchAll
                ),
                this.$events.on(
                  o['b'].EVENTS.GTT_DELETE_SUCCESS,
                  this.fetchGTT
                ),
            ...
            isRepeatOrder(t) {
              return (
                (t.variety !== o['b'].VARIETY.BO &&
                  t.variety !== o['b'].VARIETY.CO) ||
                t.order_type !== o['b'].ORDER_TYPE.SLM
              );
            },
            repeatOrder(t) {
              let e = this.instrumentManager.get(
                t.tradingsymbol,
                null,
                t.exchange
              );
            ...
            modifyOrder(t) {
              ...
              e === o['b'].VARIETY.AMO &&
                -1 ===
                  t.status
                    .toUpperCase()
                    .indexOf(o['b'].VARIETY.AMO.toUpperCase()) &&
                (e = o['b'].VARIETY.REGULAR);
              let n = t.product.toUpperCase();
              (n !== o['b'].VARIETY.CO && n !== o['b'].VARIETY.BO) ||
                (n = o['b'].PRODUCT.MIS);
            ...
            cancelSelectedOrders() {
              ...
              let t = '',
                e = '';
              'both' === this.selectedOrdersType
                ? ((t = 'Exit/Cancel orders'), (e = 'Exit/Cancel'))
                : 'exit' === this.selectedOrdersType
                ? ((t = 'Exit orders'), (e = 'Exit'))
                : ((t = 'Cancel orders'), (e = 'Cancel')),
            ...
            subscribePendingOrders() {
              if (
                ...
                !this.pendingOrders ||
                0 === this.pendingOrders.length
              )
                return;
              let t = [];
              for (let e of this.pendingOrders) t.push(e.instrument_token);
            ...
            unsubscribePendingOrders() {
              this.subscribedTokens &&
                this.subscribedTokens.length > 0 &&
                this.ticker.unsubscribe(this.subscribedTokens, d['b']);
            },
            handlePendingOrderKeyDown({ row: t, event: e }) {
              (46 !== e.keyCode && 8 !== e.keyCode) ||
                (this.selectedPendingOrders &&
                this.selectedPendingOrders.length > 1
                  ? this.cancelSelectedOrders()
                  : this.showOrderCancelModal(t));
            },
            showContextMenu(t, e, s) {
              (s = s || 'uid'), this.$set(this.contextMenu, e, t[s]);
            },
            hideContextMenu(t, e) {
            ...
            onShowContractNote() {
              ...
              this.$events.emit(
                o['b'].EVENTS.ORDER_CONTRACT_NOTE,
                [...t].reverse()
              );
            },
            hasTag(t, e) {
            ...
            fetchTags() {
              this.allTags ||
                this.allTagsFetchStatus === c['d'].API_STATUSES.fetching ||
                this.fetchAllTags();
            },
          },
        },
    ...
    c184: function (t, e, s) {
            ...
            [
              s(
                ...
                [
                  s(
                    ...
                    [
                      s('su-input', {
                        ...
                        class: [
                          'search-input-field',
                          t.styleClasses.searchInputField,
                        ],
                        attrs: {
                          type: 'text',
                          icon: 'search',
                  ...
                  t._v(' '),
                  t.showGroups && (t.query || t.showResults)
                    ? s(
                        'div',
                        {
                          staticClass: 'tabs',
                          ...
                          return s(
                            'a',
                            {
                              ...
                              on: {
                                click: function (s) {
                                  return (
                                    s.preventDefault(), t.onSelectTab(e[0])
                                  );
                                },
                              },
                            },
                  ...
                  t.showResults
                    ? s(
                        'ul',
                        {
                          class: [
                            'omnisearch-results',
                            t.styleClasses.resultsUl,
                            t.showGroups ? 'has-groups' : '',
                          ],
                        },
                        [
                          null !== t.results[t.currentTab]
                            ? s(
                                'transition-group',
                                {
                                  attrs: {
                                ...
                                t._l(t.results[t.currentTab], function (e, n) {
                                  ...
                                  return s(
                                    ...
                                    [
                                            ...
                                            [
                                              e.tags.length > 0
                                                ? s(
                                                    ...
                                                    {
                                                      staticClass:
                                                        'tag text-label text-label-outline',
                                                      class: [
                                                        e.tags[0],
                                                        t.styleClasses.exchange,
                                                        e.color,
                                                      ],
                                                    },
                                                    [
                                      ...
                                      t._v(' '),
                                      t.showActions && t.currentHoverIndex === n
                                        ? s(
                                            'div',
                                            {
                            ...
                            : t._e(),
                          t._v(' '),
                          t.results[t.currentTab] &&
                          0 !== t.results[t.currentTab].length
                            ? t._e()
                            : s(
                                'li',
                                {
                                  staticClass:
                                    'results-item text-light no-results',
                                },
                                [
                                  t.results[t.currentTab]
                                    ? t.results[t.currentTab] &&
      ...
      var _ = {
          ...
          computed: {
            addedIns() {
              let t = {};
              if (!this.addedInstruments) return t;
              for (let e of this.addedInstruments)
                e &&
                  e.tradingsymbol &&
                  e.exchange &&
                  (t[e.exchange + ':' + e.tradingsymbol] = !0);
              return t;
            },
            displayName() {
          ...
          methods: {
            ...
            onFocus(t) {
              this.$keyEvents.deregister(this.searchKeyboardShortcutEvents),
                ...
                t && t.target.select(),
                this.showGroups &&
                  (this.onSearch(this.query), (this.showResults = !0));
            },
            onBlur() {
              this.$keyEvents.deregister(this.searchKeyboardShortcutEvents);
            },
            onEnter() {
              this.$refs.input.blur(),
                this.results[this.currentTab] &&
                  this.onItemClick(
                    this.results[this.currentTab][this.current],
                    !1
                  );
            },
            onMoveUp() {
              this.results[this.currentTab] &&
                (this.current > 0
                  ? this.current--
                  : (this.current = this.results[this.currentTab].length - 1));
            },
            onMoveDown() {
              this.results[this.currentTab] &&
                (this.current < this.results[this.currentTab].length - 1
            ...
            onItemClick(t) {
              return (
                t.actions.add
                  ? this.addItem(t.instrument, !1)
                  : t.actions.link
                  ? window.open(t.actions.link)
                  : t.actions.exec && t.actions.exec(),
                !1
              );
            },
            addItem(t, e) {
            ...
            placeOrder(t, e) {
              this.$emit('place', t, e), this.clear();
            },
            isActive(t) {
              return t === this.current;
            },
            isAdded(t) {
              if (t) return this.addedIns[t.exchange + ':' + t.tradingsymbol];
            },
            onSearch(t) {
              if (this.currentTab === p) return void this.doLocalSearch(t);
              const e = t.trim();
                        ...
                        'gsecs' === t.group
                          ...
                          ? -1 !== t.tags.indexOf('open')
                            ? ((n.actions.exec = () => {
                              ...
                              (n.tags = ['open']))
                            : ((n.actions.link =
                                'https://zerodha.com/ipo/' + t.id),
                              (n.tags = []))
                          : 'mf' === t.group &&
                            (n.actions.link = `${m}/${t.tradingsymbol}`),
                          s.push(n);
                      }),
                      (this.results[t] = s),
                      (this.showResults = !0);
            ...
            clear() {
              this.$props.retainValue
                ? this.inst && (this.query = this.displayName)
                : (this.query = ''),
                this.$refs.input.blur(),
                (this.current = 0),
                (this.results = {}),
    ...
    e236: function (t, e, s) {
      ...
      function r(t, e) {
        ...
        if (t instanceof i)
          ...
          var n,
            a = -1,
            r = t.length;
          if (null == e) while (++a < r) s.set(a, t[a]);
          else while (++a < r) s.set(e((n = t[a]), a, t), n);
        } else if (t) for (var o in t) s.set(o, t[o]);
        return s;
      }
      i.prototype = r.prototype = {
        ...
        keys: function () {
          var t = [];
          for (var e in this) e[0] === a && t.push(e.slice(1));
          return t;
        },
        values: function () {
          var t = [];
          for (var e in this) e[0] === a && t.push(this[e]);
          return t;
        },
        entries: function () {
          var t = [];
        ...
        each: function (t) {
          for (var e in this) e[0] === a && t(this[e], e.slice(1), this);
        },
      };
      var o = r;
      function c() {}
      ...
      function u(t, e) {
        ...
        if (t instanceof c)
          ...
          var n = -1,
            a = t.length;
          if (null == e) while (++n < a) s.add(t[n]);
          else while (++n < a) s.add(e(t[n], n, t));
        }
        return s;
      }
      ...
      function v(t) {
        ...
        return (
          (t = null == t ? [] : p.call(t)),
          (a.domain = function (t) {
            if (!arguments.length) return s.slice();
            (s = []), (e = o());
            var n,
              i,
              r = -1,
              c = t.length;
            while (++r < c) e.has((i = (n = t[r]) + '')) || e.set(i, s.push(n));
            return a;
          }),
          (a.range = function (e) {
            return arguments.length ? ((t = p.call(e)), a) : t.slice();
          }),
      ...
      function m() {
        ...
        return (
          ...
          (s.range = function (t) {
            return arguments.length ? ((r = [+t[0], +t[1]]), d()) : r.slice();
          }),
          (s.rangeRound = function (t) {
            return (r = [+t[0], +t[1]]), (o = !0), d();
          }),
          ...
          (s.paddingOuter = function (t) {
            return arguments.length
              ? ((l = Math.max(0, Math.min(1, t))), d())
              : l;
          }),
          (s.align = function (t) {
            return arguments.length
              ? ((u = Math.max(0, Math.min(1, t))), d())
              : u;
          }),
          (s.copy = function () {
            return m()
      ...
      var _ = s('e317'),
        ...
        y = function (t, e) {
          ...
          var s,
            ...
            a = e.slice();
          return function (i) {
            for (s = 0; s < n; ++s) a[s] = t[s] * (1 - i) + e[s] * i;
            return a;
          };
        };
      function C(t) {
      ...
      function w(t, e) {
        var s,
          ...
          i = new Array(a),
          r = new Array(n);
        for (s = 0; s < a; ++s) i[s] = E(t[s], e[s]);
        for (; s < n; ++s) r[s] = e[s];
        return function (t) {
          for (s = 0; s < a; ++s) r[s] = i[s](t);
          return r;
        };
      }
      var x = function (t, e) {
      ...
      function R(t, e, s, a) {
        ...
        while (++c < i) (r[c] = s(t[c], t[c + 1])), (o[c] = a(e[c], e[c + 1]));
        return function (e) {
      ...
      function j(t, e) {
        ...
        function l() {
          return (
            (s = Math.min(i.length, r.length) > 2 ? R : I), (n = a = null), u
          );
        }
        function u(e) {
        ...
        return (
          ...
          (u.domain = function (t) {
            return arguments.length ? ((i = h.call(t, M)), l()) : i.slice();
          }),
          (u.range = function (t) {
            return arguments.length ? ((r = p.call(t)), l()) : r.slice();
          }),
          (u.rangeRound = function (t) {
            return (r = p.call(t)), (o = S), l();
          }),
          (u.clamp = function (t) {
      ...
      var U =
        /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
      function F(t) {
        if (!(e = U.exec(t))) throw new Error('invalid format: ' + t);
        var e;
        return new Y({
          fill: e[1],
          align: e[2],
      ...
      function $(t, e) {
        if (
          (s = (t = e ? t.toExponential(e - 1) : t.toExponential()).indexOf(
            'e'
          )) < 0
        )
          return null;
      ...
      var B,
        ...
        G,
        Q = function (t) {
          return (t = $(Math.abs(t))), t ? t[1] : NaN;
        },
        W = function (t, e) {
          return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(Q(e) / 3))) - Q(Math.abs(t))
          );
        },
        K = function (t, e) {
          return function (s, n) {
        ...
        X = function (t, e) {
          ...
          return i === r
            ? n
            : i > r
            ? n + new Array(i - r + 1).join('0')
            : i > 0
            ? n.slice(0, i) + '.' + n.slice(i)
            : '0.' +
              new Array(1 - i).join('0') +
              $(t, Math.max(0, e + i - 1))[0];
        },
        tt = function (t, e) {
          var s = $(t, e);
          if (!s) return t + '';
        ...
        it = function (t) {
          var e =
              void 0 === t.grouping || void 0 === t.thousands
                ? st
                : K(nt.call(t.grouping, Number), t.thousands + ''),
          ...
          function l(t) {
            ...
            function x(t) {
              ...
              switch (
                (v &&
                  p &&
                  ((t = e(O + t, O.length ? f - x.length : 1 / 0)), (O = '')),
                u)
              ) {
                case '<':
                  t = h + t + x + O;
      ...
      function rt(t) {
        return (V = it(t)), (z = V.format), (G = V.formatPrefix), V;
      }
      rt({
        decimal: '.',
        thousands: ',',
      ...
      var ot = function (t, e) {
        ...
        lt = function (t, e, s) {
          var a,
            i = t[0],
            r = t[t.length - 1],
            o = Object(n['j'])(i, r, null == e ? 10 : e);
          switch (((s = F(null == s ? ',f' : s)), s.type)) {
            case 's':
            ...
            case 'r':
              null != s.precision ||
                isNaN((a = ot(o, Math.max(Math.abs(i), Math.abs(r))))) ||
                (s.precision = a - ('e' === s.type));
              break;
            case 'f':
            case '%':
              null != s.precision ||
                isNaN((a = ct(o))) ||
                (s.precision = a - 2 * ('%' === s.type));
              break;
          }
          return z(s);
        };
      ...
      function ft() {
        ...
        return (
          (e.exponent = function (e) {
            return arguments.length ? ((t = +e), s(s())) : t;
          }),
          (e.copy = function () {
        ...
        function w(t, e) {
          return function (s) {
            ...
            while (++o < l)
              37 === t.charCodeAt(o) &&
                (r.push(t.slice(c, o)),
                null != (a = Ut[(n = t.charAt(++o))])
                  ? (n = t.charAt(++o))
                  : (a = 'e' === n ? ' ' : '0'),
                (i = e[n]) && (n = i(s, a)),
                r.push(n),
                (c = o + 1));
            return r.push(t.slice(c, o)), r.join('');
          };
        }
        function x(t, e) {
          return function (s) {
            ...
            if (
              ...
              'w' in i || (i.w = 1),
                'Z' in i
                  ? ((n = Lt(It(i.y, 0, 1))),
                    (a = n.getUTCDay()),
                    (n =
                      a > 4 || 0 === a ? Mt['a'].ceil(n) : Object(Mt['a'])(n)),
                  ...
                  : ((n = At(It(i.y, 0, 1))),
                    (a = n.getDay()),
                    (n =
                      a > 4 || 0 === a ? bt['a'].ceil(n) : Object(bt['a'])(n)),
              ...
              ('W' in i || 'U' in i) &&
                ...
                (a =
                  'Z' in i
                    ? Lt(It(i.y, 0, 1)).getUTCDay()
                    : At(It(i.y, 0, 1)).getDay()),
                (i.m = 0),
                (i.d =
                  'W' in i
                    ? ((i.w + 6) % 7) + 7 * i.W - ((a + 5) % 7)
                    : i.w + 7 * i.U - ((a + 6) % 7)));
            return 'Z' in i
              ? ((i.H += (i.Z / 100) | 0), (i.M += i.Z % 100), Lt(i))
              : At(i);
          };
        }
        function T(t, e, s, n) {
          ...
          while (r < o) {
            ...
            if (((a = e.charCodeAt(r++)), 37 === a)) {
              if (
                ...
                return -1;
            } else if (a != s.charCodeAt(n++)) return -1;
          }
          return n;
        }
        function k(t, e, s) {
          var n = l.exec(e.slice(s));
          return n ? ((t.p = u[n[0].toLowerCase()]), s + n[0].length) : -1;
        }
        function O(t, e, s) {
          var n = p.exec(e.slice(s));
          return n ? ((t.w = f[n[0].toLowerCase()]), s + n[0].length) : -1;
        }
        function E(t, e, s) {
          var n = d.exec(e.slice(s));
          return n ? ((t.w = h[n[0].toLowerCase()]), s + n[0].length) : -1;
        }
        function S(t, e, s) {
          var n = _.exec(e.slice(s));
          return n ? ((t.m = g[n[0].toLowerCase()]), s + n[0].length) : -1;
        }
        function P(t, e, s) {
          var n = v.exec(e.slice(s));
          return n ? ((t.m = m[n[0].toLowerCase()]), s + n[0].length) : -1;
        }
        function M(t, s, n) {
          return T(t, e, s, n);
        }
      ...
      function zt(t) {
        var e = {},
          s = -1,
          n = t.length;
        while (++s < n) e[t[s].toLowerCase()] = s;
        return e;
      }
      function Gt(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 1));
        return n ? ((t.w = +n[0]), s + n[0].length) : -1;
      }
      function Qt(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 1));
        return n ? ((t.u = +n[0]), s + n[0].length) : -1;
      }
      function Wt(t, e, s) {
      ...
      function Kt(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.V = +n[0]), s + n[0].length) : -1;
      }
      function Jt(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.W = +n[0]), s + n[0].length) : -1;
      ...
      function Zt(t, e, s) {
        ...
        return n ? ((t.y = +n[0]), s + n[0].length) : -1;
      }
      function Xt(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n
          ? ((t.y = +n[0] + (+n[0] > 68 ? 1900 : 2e3)), s + n[0].length)
          : -1;
      }
      function te(t, e, s) {
        var n = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(e.slice(s, s + 6));
        return n
          ? ((t.Z = n[1] ? 0 : -(n[2] + (n[3] || '00'))), s + n[0].length)
          : -1;
      }
      function ee(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 1));
        return n ? ((t.q = 3 * n[0] - 3), s + n[0].length) : -1;
      }
      function se(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.m = n[0] - 1), s + n[0].length) : -1;
      }
      function ne(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.d = +n[0]), s + n[0].length) : -1;
      }
      function ae(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 3));
        return n ? ((t.m = 0), (t.d = +n[0]), s + n[0].length) : -1;
      }
      function ie(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.H = +n[0]), s + n[0].length) : -1;
      }
      function re(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.M = +n[0]), s + n[0].length) : -1;
      }
      function oe(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 2));
        return n ? ((t.S = +n[0]), s + n[0].length) : -1;
      }
      function ce(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 3));
        return n ? ((t.L = +n[0]), s + n[0].length) : -1;
      }
      function le(t, e, s) {
        var n = Ft.exec(e.slice(s, s + 6));
        return n ? ((t.L = Math.floor(n[0] / 1e3)), s + n[0].length) : -1;
      }
      function ue(t, e, s) {
      ...
      function de(t, e, s) {
        ...
        return n ? ((t.Q = +n[0]), s + n[0].length) : -1;
      }
      function he(t, e, s) {
        var n = Ft.exec(e.slice(s));
        return n ? ((t.s = +n[0]), s + n[0].length) : -1;
      ...
      function ke(t, e) {
        return (
          (t = Te(t)),
          $t(
            bt['c'].count(Object(vt['a'])(t), t) +
              (4 === Object(vt['a'])(t).getDay()),
            e,
            2
          )
        );
      ...
      function Pe(t, e) {
        return (t = Te(t)), $t(t.getFullYear() % 100, e, 2);
      }
      function Me(t, e) {
      ...
      function Ne(t, e) {
        var s = t.getDay();
        return (
          (t = s >= 4 || 0 === s ? Object(bt['c'])(t) : bt['c'].ceil(t)),
      ...
      function Ve(t, e) {
        return (
          (t = Be(t)),
          $t(
            Mt['c'].count(Object(Dt['a'])(t), t) +
              (4 === Object(Dt['a'])(t).getUTCDay()),
            e,
            2
          )
        );
      ...
      function We(t, e) {
        return (t = Be(t)), $t(t.getUTCFullYear() % 100, e, 2);
      }
      function Ke(t, e) {
      ...
      function Je(t, e) {
        var s = t.getUTCDay();
        return (
          (t = s >= 4 || 0 === s ? Object(Mt['c'])(t) : Mt['c'].ceil(t)),
      ...
      function hs(t, e, s, a, i, r, o, c, l) {
        ...
        function k(e, s, a, i) {
          if ((null == e && (e = 10), 'number' === typeof e)) {
            ...
            o === x.length
              ? ((i = Object(n['j'])(s / ls, a / ls, e)), (e = t))
              : o
              ? ((o = x[r / x[o - 1][2] < x[o][2] / r ? o - 1 : o]),
                (i = o[1]),
                (e = o[0]))
              : ((i = Math.max(Object(n['j'])(s, a, e), 1)), (e = c));
          }
      ...
      var ps = function () {
          return hs(vt['a'], gt, bt['b'], yt['a'], xt, kt, Et, Pt, jt).domain([
            new Date(2e3, 0, 1),
            new Date(2e3, 0, 2),
          ]);
        },
        ...
        gs =
          (_s('1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf'),
          _s(
        ...
        Ss = ws * xs - Ts * Cs;
      function Ps(t) {
        if (t instanceof Ns) return new Ns(t.h, t.s, t.l, t.opacity);
      ...
      Object(gs['a'])(
        ...
        Object(gs['b'])(g['a'], {
          brighter: function (t) {
            return (
              (t = null == t ? g['c'] : Math.pow(g['c'], t)),
              new Ns(this.h, this.s, this.l * t, this.opacity)
            );
          },
          darker: function (t) {
            return (
              (t = null == t ? g['d'] : Math.pow(g['d'], t)),
              new Ns(this.h, this.s, this.l * t, this.opacity)
            );
          },
          rgb: function () {
      ...
      function As(t) {
        return (function e(s) {
          ...
          return (s = +s), (n.gamma = e), n;
        })(1);
      }
      As(Ds['c']);
      var Ls = As(Ds['a']);
      Ls(Ms(300, 0.5, 0), Ms(-240, 0.5, 1)),
        Ls(Ms(-100, 0.75, 0.35), Ms(80, 1.5, 0.8)),
        Ls(Ms(260, 0.75, 0.35), Ms(80, 1.5, 0.8)),
        Ms();
      function Is(t) {
        var e = t.length;
        return function (s) {
      ...
      function c(t) {
        return function (e) {
          ...
          return (
            ...
            (a.opacity = 1),
            function (t) {
              return (a.r = r(t)), (a.g = o(t)), (a.b = c(t)), a + '';
            }
          );
        };
      }
                      ...
                      s(
                        ...
                        [
                          s(
                            ...
                            [t._v(t._s(t.order.tradingsymbol))]
                          ),
                          s('br'),
                          t._v(' '),
                          s(
                  ...
                  s(
                    ...
                    [
                      s(
                        ...
                        {
                          class: [
                            'buy' == t.order.transaction_type.toLowerCase()
                              ? 'button-orange'
                              : 'button-blue',
                          ],
                          attrs: {
                        ...
                        [
                          t.order.isExit
                            ? t._e()
                            : s('span', [t._v('Cancel order')]),
                          t._v(' '),
                          t.order.isExit
                            ? s('span', [t._v('Exit order')])
                            : t._e(),
                        ]
                      ),
                      t._v(' '),
            ...
            apiCancelOrder(t) {
              ...
              e === r['b'].VARIETY.AMO &&
                -1 ===
                  t.status
                    .toUpperCase()
                    .indexOf(r['b'].VARIETY.AMO.toUpperCase()) &&
                (e = r['b'].VARIETY.REGULAR);
              let s = {
                order_id: t.order_id,
                ...
                i['a']
                  ...
                  .then((t) => {
                    ...
                    this.$toast.info({
                      title: 'Request sent',
                      message:
                        "Cancellation request for the order has been sent<br />Check the orderbook for status<br /><span class='order-id'>#" +
                        e +
                        '</span>',
                      id: e,
    ...
    e48b: function (t, e, s) {
      ...
      var n = s('6fd3'),
        a = function (t) {
          ...
          for (
            var e = this._groups, s = e.length, a = new Array(s), i = 0;
            i < s;
            ++i
          )
            for (
              ...
              (r = c[d]) &&
                (o = t.call(r, r.__data__, d, c)) &&
                ('__data__' in r && (o.__data__ = r.__data__), (u[d] = o));
        ...
        r = function (t) {
          ...
          for (
            var e = this._groups, s = e.length, n = [], a = [], r = 0;
            r < s;
            ++r
          )
            for (var o, c = e[r], l = c.length, u = 0; u < l; ++u)
              (o = c[u]) && (n.push(t.call(o, o.__data__, u, c)), a.push(o));
          return new Pt(n, a);
        },
        o = s('0a78'),
        c = function (t) {
          ...
          for (
            var e = this._groups, s = e.length, n = new Array(s), a = 0;
            a < s;
            ++a
          )
            for (
              var i, r = e[a], c = r.length, l = (n[a] = []), u = 0;
              u < c;
              ++u
            )
      ...
      function f(t, e, s, n, a, i) {
        for (var r, o = 0, c = e.length, l = i.length; o < l; ++o)
          (r = e[o])
            ? ((r.__data__ = i[o]), (n[o] = r))
            : (s[o] = new d(t, i[o]));
        for (; o < c; ++o) (r = e[o]) && (a[o] = r);
      }
      function v(t, e, s, n, a, i, r) {
        ...
        for (o = 0; o < h; ++o)
          (c = e[o]) &&
            ((v[o] = l = p + r.call(c, c.__data__, o, e)),
            l in u ? (a[o] = c) : (u[l] = c));
        for (o = 0; o < f; ++o)
          (l = p + r.call(t, i[o], o, i)),
            (c = u[l])
              ? ((n[o] = c), (c.__data__ = i[o]), (u[l] = null))
              : (s[o] = new d(t, i[o]));
        for (o = 0; o < h; ++o) (c = e[o]) && u[v[o]] === c && (a[o] = c);
      }
      var m = function (t, e) {
          if (!t)
            return (
          ...
          return (r = new Pt(r, n)), (r._enter = o), (r._exit = c), r;
        },
        _ = function () {
        ...
        g = function (t, e, s) {
          var n = this.enter(),
            ...
            i = this.exit();
          return (
            (n = 'function' === typeof t ? t(n) : n.append(t + '')),
            null != e && (a = e(a)),
            null == s ? i.remove() : s(i),
        ...
        C = function (t) {
          ...
          t || (t = w);
          for (
            var s = this._groups, n = s.length, a = new Array(n), i = 0;
            i < n;
            ++i
          ) {
            for (
              var r, o = s[i], c = o.length, l = (a[i] = new Array(c)), u = 0;
              u < c;
              ++u
            )
              (r = o[u]) && (l[u] = r);
      ...
      function I(t, e) {
        return function () {
          ...
          null == s
            ? this.removeAttributeNS(t.space, t.local)
            : this.setAttributeNS(t.space, t.local, s);
        };
      }
      var R = function (t, e) {
          var s = Object(P['a'])(t);
          if (arguments.length < 2) {
            var n = this.node();
            return s.local
              ? n.getAttributeNS(s.space, s.local)
              : n.getAttribute(s);
          }
          return this.each(
            (null == e
      ...
      var Y = function (t, e) {
        return arguments.length > 1
          ? this.each((null == e ? j : 'function' === typeof e ? F : U)(t, e))
          : this.node()[t];
      };
      function H(t) {
      ...
      var K = function (t, e) {
        ...
        if (arguments.length < 2) {
          var n = $(this.node()),
            a = -1,
            i = s.length;
          while (++a < i) if (!n.contains(s[a])) return !1;
          return !0;
        }
      ...
      var tt = function (t) {
        return arguments.length
          ? this.each(null == t ? J : ('function' === typeof t ? X : Z)(t))
      ...
      var at = function (t) {
        return arguments.length
          ? this.each(null == t ? et : ('function' === typeof t ? nt : st)(t))
          : this.node().innerHTML;
      };
      function it() {
      ...
      function ut(t) {
        return function () {
          var e = this.ownerDocument,
            s = this.namespaceURI;
          return s === lt['b'] && e.documentElement.namespaceURI === lt['b']
            ? e.createElement(t)
            : e.createElementNS(s, t);
        };
      }
      function dt(t) {
        return function () {
      ...
      function Tt(t, e, s) {
        ...
        'function' === typeof a
          ...
          : ((a = n.document.createEvent('Event')),
            s
              ? (a.initEvent(e, s.bubbles, s.cancelable), (a.detail = s.detail))
              : a.initEvent(e, !1, !1)),
          t.dispatchEvent(a);
      }
      function kt(t, e) {
    ...
    f586: function (t, e, s) {
      ...
      function o(t, e) {
        return n['a'].put(
          Object(a['a'])('marketwatches.update', {
            watchId: t,
          }),
          e
        );
      ...
      function c(t, e) {
        return n['a'].delete(
          Object(a['a'])('marketwatches.delete', {
            watchId: t,
            itemId: e,
          })
        );
